...
const en: Dict = {
  ...
  "campaigns.err.required": "A title and a budget above 0 are required.",
  ...
  "campaigns.launchConfirmMsg": "Launching starts the campaign and charges a one-time {fee} fee. Unspent budget is never charged.",
...
const de: Dict = {
  ...
  "campaigns.err.required": "Titel und ein Budget über 0 sind erforderlich.",
  "campaigns.budget": "Budget",
  ...
  "campaigns.launchConfirmMsg": "Beim Start wird die Kampagne aktiviert und eine einmalige Gebühr von {fee} berechnet. Nicht genutztes Budget wird nie berechnet.",
