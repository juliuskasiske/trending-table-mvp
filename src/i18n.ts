...
const en: Dict = {
  ...
  "campaigns.launchConfirmMsg": "Launching starts the campaign and charges a one-time {fee} fee. By starting, you agree that we may match creators at our sole discretion and charge the campaign budget you specified.",
  ...
  "campaigns.noPosts": "No creator content yet. We'll add creators to this campaign shortly.",
  ...
  "messages.comingSoon": "Direct messaging with creators is on the way — for now we handle matching for you.",
...
const de: Dict = {
  ...
  "campaigns.launchConfirmMsg": "Beim Start wird die Kampagne aktiviert und eine einmalige Gebühr von {fee} berechnet. Mit dem Start stimmst du zu, dass wir nach eigenem Ermessen Creator zuordnen und das von dir festgelegte Kampagnenbudget berechnen dürfen.",
  ...
  "campaigns.noPosts": "Noch kein Creator-Content. Wir fügen dieser Kampagne bald Creator hinzu.",
  ...
  "messages.comingSoon": "Direktnachrichten mit Creatorn kommen bald — vorerst übernehmen wir das Matching für dich.",
