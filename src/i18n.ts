...
const en: Dict = {
  ...
  "dash.sub": "Your restaurants. Pick one to run campaigns, or add another.",
  "dash.new": "Add restaurant",
  "dash.empty": "No restaurants yet — add your first.",
  "dash.manage": "Manage",
  "dash.search": "Find your restaurant on Google",
  "dash.searchPh": "Restaurant name…",
  "dash.searchBtn": "Search",
  "dash.searching": "Searching…",
  "dash.noMatch": "No matches — try the manual option below.",
  "dash.or": "or add it manually:",
  "dash.manualPh": "Restaurant name",
  "dash.add": "Add",
...
const de: Dict = {
  ...
  "dash.sub": "Deine Restaurants. Wähle eins für Kampagnen aus oder füge ein weiteres hinzu.",
  "dash.new": "Restaurant hinzufügen",
  "dash.empty": "Noch keine Restaurants — füge dein erstes hinzu.",
  "dash.manage": "Verwalten",
  "dash.search": "Finde dein Restaurant bei Google",
  "dash.searchPh": "Restaurantname…",
  "dash.searchBtn": "Suchen",
  "dash.searching": "Suche…",
  "dash.noMatch": "Keine Treffer — nutze unten die manuelle Option.",
  "dash.or": "oder manuell hinzufügen:",
  "dash.manualPh": "Restaurantname",
  "dash.add": "Hinzufügen",
