...
const en: Dict = {
  ...
  "gate.forgot": "Forgot password?",
  "gate.forgotSub": "Enter your email and we'll send you a reset link.",
  "gate.forgotSend": "Send reset link",
  "gate.forgotBack": "Back to login",
  "gate.forgotSent": "If {email} has an account, a reset link is on its way.",
  "gate.pwReset": "Password updated — you can log in now.",
  "reset.eyebrow": "Reset password",
  "reset.title": "Set a new password",
  "reset.pw1": "Enter password",
  "reset.pw2": "Enter password again",
  "reset.submit": "Set password",
  "reset.fail": "Couldn't reset the password. The link may be invalid or expired.",
  "gate.restaurant.title": "Locale",
  ...
  "gate.soon.restaurantLogin": "Locale login is coming soon. For now, use Sign up to get started.",
  "progress.step": "Step",
  "progress.of": "of",
  ...
  // Step 1 — account
  "account.eyebrow": "Register as a locale",
  ...
  "account.email.ph": "owner@yourlocale.com",
  "account.email.err": "Enter a valid email address.",
  "account.email.taken": "This email is already registered.",
  "account.email.takenCta": "Log in instead",
  "account.password.label": 'Password <span class="hint">(min. 8 characters)</span>',
  "account.password.err": "Use at least 8 characters.",
  "account.password2.label": "Confirm password",
  "account.password2.err": "Passwords don't match.",
  ...
  "guidelines.handle.ph": "@yourlocale",
  ...
  "review.sub": "Check the details, then create your locale account.",
  "review.group.account": "Account",
  "review.group.restaurant": "Locale",
  ...
  "review.avoid": "Avoid",
  "review.consent":
    "I agree to the Terms and Privacy Policy. Creating a locale is free; launching a campaign costs a €19.99 fee.",
  "review.consent.err": "Please accept the terms to continue.",

  // Success
  "done.title": "You're in.",
  "done.p1": "Your locale account for ",
  "done.p2":
  ...
  "done.restart": "Start another locale",

  // Step names (progress label)
  "stepname.account": "Create account",
  "stepname.verify": "Confirm email",
  "stepname.payment": "Payment",
  "stepname.restaurant": "Find your locale",
  ...
  "search.typePrompt": "Type your locale name and city, then hit Search.",
  ...
  "pay.finishRestaurant": "Finish the locale step first.",
  ...
  "pay.eyebrow": "Set up billing",
  "pay.setupTitle": "Add a payment method",
  "pay.sub": "We save a card so we can bill the platform fee and usage once your locales go live. You won't be charged now.",
  "pay.disabled": "Payments aren't enabled yet — you can add a card later from your account.",
  "pay.later": "Add later",
  "pay.save": "Save card & continue",
  "pay.error": "Couldn't save the card. Check the details and try again.",
  ...
  "chip.Plating close-ups": "Dish close-up",
  "chip.Exterior / storefront": "Locale exterior",
  ...
  "account.nav.restaurants": "Locales",
  ...
  "account.nav.campaigns": "Campaigns",
  "restaurants.sub": "Your locales. Pick one to run campaigns, or add another.",
  "restaurants.new": "Add locale",
  "restaurants.empty": "No locales yet — add your first.",
  "restaurants.manage": "Manage",
  "restaurants.search": "Find your locale on Google",
  "restaurants.searchPh": "Locale name…",
  "restaurants.searchBtn": "Search",
  "restaurants.searching": "Searching…",
  "restaurants.noMatch": "No matches — try the manual option below.",
  "restaurants.manualToggle": "Can't find it? Enter the details manually",
  "restaurants.backToSearch": "← Back to search",
  "restaurants.loadingDetails": "Loading details…",
  "restaurants.err.name": "Enter a locale name.",
  "restaurants.or": "or add it manually:",
  "restaurants.manualPh": "Locale name",
  "restaurants.add": "Add",
  "restaurants.delete": "Delete locale",
  "restaurants.deleteHint": "Permanently remove this locale and its campaigns. This can't be undone.",
  "restaurants.deleteConfirm": "Type the locale name ({name}) to confirm deletion.",
  "account.nav.messages": "Messages",
  "account.nav.services": "Services",
  "account.services.title": "Services",
  "account.services.sub": "Book add-ons to make your locale more visible and get more out of Trending Table.",
  "account.services.visibility": "More visibility",
  "account.services.visibilityDesc": "Push your locale to the top so more people discover it.",
  "account.services.rights": "Usage rights",
  "account.services.rightsDesc": "Secure the rights to reuse creator content for your own marketing.",
  "account.error": "Something went wrong.",
  "campaigns.sub": "Create a campaign, set a budget, and we bring the creators.",
  "campaigns.noRestaurant": "Add a locale first to run campaigns.",
  "campaigns.new": "New campaign",
  "campaigns.empty": "No campaigns yet — create your first above.",
  "campaigns.untitled": "Untitled campaign",
  "campaigns.create": "Create campaign",
  "campaigns.f.title": "Campaign title",
  "campaigns.f.budget": "Budget (€)",
  "campaigns.f.deadline": "Post content by",
  "campaigns.f.restaurant": "Locale",
  "campaigns.f.guidelines": "Content guidelines",
  "campaigns.g.add": "Add your own",
  "campaigns.g.addPh": "Type and press Enter",
  "campaigns.f.guidelinesPh": "What should creators show / mention / avoid?",
  "campaigns.estimateHint": "Enter a budget to see expected views.",
  "campaigns.estimate": "≈ {n} expected views",
  "campaigns.err.required": "Locale, title, budget and a post-by date are required.",
  "campaigns.err.minBudget": "The minimum campaign budget is {min}.",
  "campaigns.err.minDeadline": "The post-by date must be at least 3 weeks from today.",
  "campaigns.budget": "Budget",
  "campaigns.estViews": "Est. views",
  "campaigns.views": "Views so far",
  "campaigns.posted": "Posted",
  "campaigns.creators": "Posted / reached",
  "campaigns.deadline": "Deadline",
  "campaigns.by": "Post by {date}",
  "campaigns.back": "Back to campaigns",
  "campaigns.launch": "Launch campaign · {fee}",
  "campaigns.launchConfirmTitle": "Launch this campaign?",
  "campaigns.launchConfirmMsg": "Launching starts the campaign and charges a one-time {fee} fee. By starting, you agree that we may match creators at our sole discretion and allocate the campaign budget you specified.",
  "campaigns.launchConfirmCta": "Launch & pay {fee}",
  "campaigns.cancel": "Cancel campaign",
  "campaigns.cancelConfirmTitle": "Cancel this campaign?",
  "campaigns.cancelConfirmMsg": "The campaign will be marked as cancelled. You won't be charged for any unspent budget.",
  "campaigns.cancelConfirmCta": "Cancel campaign",
  "campaigns.end": "End campaign",
  "campaigns.endConfirmTitle": "End this campaign?",
  "campaigns.endConfirmMsg": "We'll settle the campaign and charge your card the unspent remainder of the budget. This can't be undone.",
  "campaigns.endConfirmCta": "End & settle",
  "campaigns.keepIt": "Keep it",
  "campaigns.guidelines": "Guidelines",
  "campaigns.g.notesPh": "Anything else creators should know (optional)",
  "campaigns.noPosts": "The creator search is underway. As soon as content exists, it'll be shown here.",
  "campaigns.viewsOverTime": "Views over time",
  "campaigns.noData": "No view data yet — it appears once creators post.",
  "campaigns.comments": "Comments",
  "campaigns.shares": "Shares",
  "campaigns.saves": "Saves",
  ...
  "creators.verifying": "Unlocking soon.",
  "messages.comingSoon": "Unlocking soon.",
  "account.nav.settings": "Settings",
  "account.settings.restaurants": "Locales",
  ...
  "bookings.noRestaurant": "Add a locale first to start booking creators.",
  ...
  "account.rest.title": "Your locales",
  "account.rest.add": "Add a locale",
  "account.rest.empty": "No locales yet.",
  ...
  "account.profile.priceNone": "—",
  "account.profile.secLocation": "Location",
  "account.profile.secAbout": "About the locale",
  "account.profile.secBrand": "Web & brand",
  "account.menu.uploadPdf": "Upload menu PDF",
  "account.menu.improveAi": "Improve with AI",
  ...
  "account.danger.deleteRestaurant": "Delete this locale",
  ...
  "account.danger.deleteRestaurantConfirm": "Type the locale name ({name}) to confirm.",
  ...
  "creator.signup.sub": "Get matched with local locales and earn per view.",
  ...
  "creator.handles.statsHint": "Rough numbers are fine — you can update them anytime.",
  "creator.profile.title": "About you",
  "creator.profile.sub": "A few details so locales know who they're working with.",
  "creator.profile.name": "Name",
  "creator.profile.age": "Age",
  "creator.profile.gender": "Gender",
  "creator.profile.followers": "Total followers",
  "creator.profile.picHint": "Add a photo",
  "creator.profile.picCta": "Choose image",
  "creator.profile.picNote": "Square works best.",
  "creator.profile.picRemove": "Remove",
  "creator.profile.picFail": "Couldn't read that image — try another.",
  "creator.profile.needAll": "Please fill in all fields.",
  "creator.profile.picTooBig": "That image is too large (max 3 MB).",
  "creator.profile.needName": "Enter your name.",
  "creator.profile.cta": "Continue",
  "creator.pgender.female": "Female",
  "creator.pgender.male": "Male",
  "creator.pgender.diverse": "Non-binary",
  "creator.pgender.prefer_not": "Prefer not to say",
  "creator.channels.topCities": "Top audience cities (top 5)",
  "creator.channels.ageRange": "Top age ranges",
  "creator.channels.gender": "Top gender",
  "creator.channels.rankHint": "(tap in order — highest first)",
  "creator.city.pick": "Select…",
  "creator.city.otherDe": "Other within Germany",
  "creator.city.otherIntl": "Other outside Germany",
  "creator.aud.men": "Men",
  "creator.aud.women": "Women",
  "cr.m.ig.views": "Views (30 days)",
  "cr.m.ig.reached": "Accounts reached (30 days)",
  "cr.m.ig.clicks": "External link clicks",
  "cr.m.tt.views": "Video views (28 days)",
  "cr.m.tt.reached": "Total viewers (28 days)",
  "cr.m.tt.clicks": "Bio link clicks",
  "cr.m.yt.views": "Views",
  "cr.m.yt.reached": "Unique viewers",
  "cr.m.yt.clicks": "End-screen + card clicks",
  "creator.handles.cta": "Continue",
  "creator.handles.working": "Saving…",
  "creator.handles.needOne": "Enter at least one handle.",
  "creator.handles.needComplete": "Finish at least one channel: all 5 cities, every age group and gender ranked, and all three metrics.",
  ...
  "creator.done.sub": "We'll match you with locales that fit your content. Watch your inbox.",
  "creator.done.inbox": "Go to my inbox",
  "creator.home.accounts": "Manage accounts",
  "creator.home.title": "Trending Table",
  "creator.venueFallback": "Locale",
  "creator.tab.campaigns": "Campaigns",
  "creator.tab.messages": "Messages",
  "creator.nav.services": "Services",
  "creator.nav.account": "Account",
  "creator.services.title": "Services",
  "creator.services.sub": "Book plans and add-ons to get more out of Trending Table.",
  "creator.services.loading": "Loading services…",
  "creator.services.yourPlan": "Your plan",
  "creator.services.yourPlanDesc": "This is the subscription you're currently on.",
  "creator.services.upgrade": "Upgrade your plan",
  "creator.services.upgradeDesc": "Move up to a higher plan for more collaborations and reach.",
  "creator.services.moreJobs": "Land more bookings",
  "creator.services.moreJobsDesc": "One-off add-ons that boost your visibility so brands find you faster.",
  "creator.services.recommended": "Recommended",
  "creator.services.currentBadge": "Current plan",
  "creator.services.topPlan": "You're already on the top plan.",
  "creator.services.catalogEmpty": "No services available right now.",
  "creator.services.book": "Book now",
  "creator.services.booked": "Booked",
  "creator.services.redirecting": "Redirecting…",
  "creator.services.since": "since",
  "creator.services.free": "Free",
  "creator.services.perMonth": "/ month",
  "creator.services.oneTime": "one-off",
  "creator.services.stripeOff": "Payments aren't enabled on this environment yet — services can't be booked here.",
  "creator.services.coops": "Up to {n} collaborations",
  "creator.services.coopsOne": "Up to {n} collaboration",
  "creator.services.coopsUnlimited": "Unlimited collaborations",
  "creator.services.freeCoops": "One collaboration every 3 months",
  "creator.services.advancedCoops": "Up to six collaborations every 3 months",
  "creator.services.inclBoost": "Visibility boost included",
  "creator.services.boostDays": "{n} days of boosted visibility",
  "creator.services.blockMonths": "{n}-month commitment",
  "creator.services.usageMonths": "{n} months of usage rights",
  "creator.account.sub": "Manage your profile and the channels brands see when we match you.",
  "creator.account.profileTab": "Profile",
  "creator.account.channelsTab": "Channels",
  "creator.campaigns.soon": "Your matched campaigns will show up here once we pair you with locales.",
  "creator.campaigns.empty": "No campaigns yet — locales we match you with show up here.",
  "creator.campaigns.untitled": "Untitled campaign",
  "creator.campaigns.payout": "Your payout",
  "creator.campaigns.by": "post by",
  "creator.campaigns.linkPh": "Paste your post link…",
  "creator.campaigns.submit": "Submit post",
  "creator.campaigns.update": "Update link",
  "assignment.status.contacted": "Invited",
  "assignment.status.posted": "Submitted",
  "assignment.status.approved": "Approved",
  "assignment.status.paid": "Paid",
...
const de: Dict = {
  ...
  "gate.forgotSub": "Gib deine E-Mail ein und wir senden dir einen Link zum Zurücksetzen.",
  "gate.forgotSend": "Link senden",
  "gate.forgotBack": "Zurück zur Anmeldung",
  "gate.forgotSent": "Falls {email} ein Konto hat, ist ein Link zum Zurücksetzen unterwegs.",
  "gate.pwReset": "Passwort aktualisiert — du kannst dich jetzt anmelden.",
  "reset.eyebrow": "Passwort zurücksetzen",
  "reset.title": "Neues Passwort setzen",
  "reset.pw1": "Passwort eingeben",
  "reset.pw2": "Passwort erneut eingeben",
  "reset.submit": "Passwort setzen",
  "reset.fail": "Passwort konnte nicht zurückgesetzt werden. Der Link ist ggf. ungültig oder abgelaufen.",
  "gate.restaurant.title": "Lokal",
  ...
  "gate.soon.restaurantLogin": "Der Lokal-Login kommt bald. Nutze vorerst „Registrieren“, um zu starten.",
  ...
  "account.eyebrow": "Als Lokal registrieren",
  "account.title": "Konto erstellen",
  "account.sub":
    "Spar dir das Werbebudget. Buche lokale Creator und füll deine Tische. Das ist das Einzige, was du selbst eintippst — den Rest regeln wir für dich.",
  ...
  "account.email.taken": "Diese E-Mail ist bereits registriert.",
  "account.email.takenCta": "Stattdessen anmelden",
  "account.password.label": 'Passwort <span class="hint">(mind. 8 Zeichen)</span>',
  "account.password.err": "Verwende mindestens 8 Zeichen.",
  "account.password2.label": "Passwort bestätigen",
  "account.password2.err": "Passwörter stimmen nicht überein.",
  ...
  "review.sub": "Prüf die Angaben und erstell dann dein Lokal-Konto.",
  "review.group.account": "Konto",
  "review.group.restaurant": "Lokal",
  ...
  "review.consent":
    "Ich stimme den AGB und der Datenschutzerklärung zu. Ein Lokal anzulegen ist kostenlos; eine Kampagne zu starten kostet 19,99 €.",
  "review.consent.err": "Bitte akzeptiere die Bedingungen, um fortzufahren.",

  "done.title": "Du bist dabei.",
  "done.p1": "Dein Lokal-Konto für ",
  "done.p2":
  ...
  "done.restart": "Weiteres Lokal hinzufügen",

  "stepname.account": "Konto erstellen",
  "stepname.verify": "E-Mail bestätigen",
  "stepname.payment": "Zahlung",
  "stepname.restaurant": "Lokal finden",
  ...
  "search.typePrompt": "Gib Lokalname und Stadt ein und klick auf Suchen.",
  ...
  "pay.finishRestaurant": "Schließ zuerst den Lokal-Schritt ab.",
  ...
  "pay.eyebrow": "Abrechnung einrichten",
  "pay.setupTitle": "Zahlungsmethode hinzufügen",
  "pay.sub": "Wir hinterlegen eine Karte, um die Plattformgebühr und Nutzung abzurechnen, sobald deine Lokale live sind. Jetzt wird nichts berechnet.",
  "pay.disabled": "Zahlungen sind noch nicht aktiviert — du kannst später in deinem Konto eine Karte hinzufügen.",
  "pay.later": "Später hinzufügen",
  "pay.save": "Karte speichern & weiter",
  "pay.error": "Die Karte konnte nicht gespeichert werden. Prüf die Angaben und versuch es erneut.",
  ...
  "chip.Plating close-ups": "Close-Up des Gerichts",
  "chip.Exterior / storefront": "Außenansicht des Lokals",
  ...
  "account.nav.restaurants": "Lokale",
  "account.nav.account": "Konto & Sicherheit",
  "account.nav.dashboard": "Dashboard",
  "account.nav.creators": "Creator finden",
  "account.nav.bookings": "Buchungen",
  "account.nav.campaigns": "Kampagnen",
  "restaurants.sub": "Deine Lokale. Wähle eins für Kampagnen aus oder füge ein weiteres hinzu.",
  "restaurants.new": "Lokal hinzufügen",
  "restaurants.empty": "Noch keine Lokale — füge dein erstes hinzu.",
  "restaurants.manage": "Verwalten",
  "restaurants.search": "Finde dein Lokal bei Google",
  "restaurants.searchPh": "Lokalname…",
  "restaurants.searchBtn": "Suchen",
  "restaurants.searching": "Suche…",
  "restaurants.noMatch": "Keine Treffer — nutze unten die manuelle Option.",
  "restaurants.manualToggle": "Nicht gefunden? Details manuell eingeben",
  "restaurants.backToSearch": "← Zurück zur Suche",
  "restaurants.loadingDetails": "Details werden geladen…",
  "restaurants.err.name": "Gib einen Lokalnamen ein.",
  "restaurants.or": "oder manuell hinzufügen:",
  "restaurants.manualPh": "Lokalname",
  "restaurants.add": "Hinzufügen",
  "restaurants.delete": "Lokal löschen",
  "restaurants.deleteHint": "Dieses Lokal und seine Kampagnen dauerhaft entfernen. Das kann nicht rückgängig gemacht werden.",
  "restaurants.deleteConfirm": "Gib den Lokalnamen ({name}) ein, um das Löschen zu bestätigen.",
  "account.nav.messages": "Nachrichten",
  "account.nav.services": "Service",
  "account.services.title": "Service",
  "account.services.sub": "Buche Add-ons, um dein Lokal sichtbarer zu machen und mehr aus Trending Table herauszuholen.",
  "account.services.visibility": "Mehr Sichtbarkeit",
  "account.services.visibilityDesc": "Bring dein Lokal nach vorne, damit es häufiger entdeckt wird.",
  "account.services.rights": "Nutzungsrechte",
  "account.services.rightsDesc": "Sichere dir die Rechte, Creator-Content für dein eigenes Marketing weiterzuverwenden.",
  "account.error": "Etwas ist schiefgelaufen.",
  "campaigns.sub": "Erstelle eine Kampagne, lege ein Budget fest — wir bringen die Creator.",
  "campaigns.noRestaurant": "Füge zuerst ein Lokal hinzu, um Kampagnen zu starten.",
  "campaigns.new": "Neue Kampagne",
  "campaigns.empty": "Noch keine Kampagnen — erstelle oben deine erste.",
  "campaigns.untitled": "Unbenannte Kampagne",
  "campaigns.create": "Kampagne erstellen",
  "campaigns.f.title": "Kampagnentitel",
  "campaigns.f.budget": "Budget (€)",
  "campaigns.f.deadline": "Inhalt posten bis",
  "campaigns.f.restaurant": "Lokal",
  "campaigns.f.guidelines": "Content-Richtlinien",
  "campaigns.g.add": "Eigene hinzufügen",
  "campaigns.g.addPh": "Eingeben und Enter drücken",
  "campaigns.f.guidelinesPh": "Was sollen Creator zeigen / erwähnen / vermeiden?",
  "campaigns.estimateHint": "Gib ein Budget ein, um erwartete Aufrufe zu sehen.",
  "campaigns.estimate": "≈ {n} erwartete Aufrufe",
  "campaigns.err.required": "Lokal, Titel, Budget und ein Post-bis-Datum sind erforderlich.",
  "campaigns.err.minBudget": "Das Mindestbudget beträgt {min}.",
  "campaigns.err.minDeadline": "Das Post-bis-Datum muss mindestens 3 Wochen in der Zukunft liegen.",
  "campaigns.budget": "Budget",
  "campaigns.estViews": "Erw. Aufrufe",
  "campaigns.views": "Aufrufe bisher",
  "campaigns.posted": "Gepostet",
  "campaigns.creators": "Gepostet / erreicht",
  "campaigns.deadline": "Frist",
  "campaigns.by": "Posten bis {date}",
  "campaigns.back": "Zurück zu Kampagnen",
  "campaigns.launch": "Kampagne starten · {fee}",
  "campaigns.launchConfirmTitle": "Diese Kampagne starten?",
  "campaigns.launchConfirmMsg": "Beim Start wird die Kampagne aktiviert und eine einmalige Gebühr von {fee} berechnet. Mit dem Start stimmst du zu, dass wir nach eigenem Ermessen Creator zuordnen und das von dir festgelegte Kampagnenbudget zuweisen dürfen.",
  "campaigns.launchConfirmCta": "Starten & {fee} zahlen",
  "campaigns.cancel": "Kampagne stornieren",
  "campaigns.cancelConfirmTitle": "Diese Kampagne stornieren?",
  "campaigns.cancelConfirmMsg": "Die Kampagne wird als storniert markiert. Für nicht genutztes Budget fallen keine Kosten an.",
  "campaigns.cancelConfirmCta": "Kampagne stornieren",
  "campaigns.end": "Kampagne beenden",
  "campaigns.endConfirmTitle": "Diese Kampagne beenden?",
  "campaigns.endConfirmMsg": "Wir rechnen die Kampagne ab und belasten deine Karte mit dem nicht genutzten Rest des Budgets. Das kann nicht rückgängig gemacht werden.",
  "campaigns.endConfirmCta": "Beenden & abrechnen",
  "campaigns.keepIt": "Behalten",
  "campaigns.guidelines": "Richtlinien",
  "campaigns.g.notesPh": "Sonstiges, das Creator wissen sollten (optional)",
  "campaigns.noPosts": "Die Creator-Suche läuft. Sobald Inhalte existieren, werden sie hier sichtbar gemacht.",
  "campaigns.viewsOverTime": "Aufrufe im Zeitverlauf",
  "campaigns.noData": "Noch keine Aufrufdaten — sie erscheinen, sobald Creator posten.",
  "campaigns.comments": "Kommentare",
  "campaigns.shares": "Shares",
  "campaigns.saves": "Saves",
  "campaigns.status.draft": "Entwurf",
  "campaigns.status.active": "Aktiv",
  "campaigns.status.completed": "Abgeschlossen",
  "campaigns.status.cancelled": "Storniert",
  "creators.verifying": "Wird demnächst freigeschaltet",
  "messages.comingSoon": "Wird demnächst freigeschaltet",
  "account.nav.settings": "Einstellungen",
  "account.settings.restaurants": "Lokale",
  ...
  "bookings.noRestaurant": "Füge zuerst ein Lokal hinzu, um Creator zu buchen.",
  ...
  "account.rest.title": "Deine Lokale",
  "account.rest.add": "Lokal hinzufügen",
  "account.rest.empty": "Noch keine Lokale.",
  "account.rstatus.provisioning": "In Einrichtung",
  ...
  "account.profile.priceNone": "—",
  "account.profile.secLocation": "Standort",
  "account.profile.secAbout": "Über das Lokal",
  "account.profile.secBrand": "Web & Marke",
  "account.menu.uploadPdf": "Speisekarte als PDF hochladen",
  "account.menu.improveAi": "Mit KI verbessern",
  ...
  "account.danger.deleteRestaurant": "Dieses Lokal löschen",
  ...
  "account.danger.deleteRestaurantConfirm": "Gib den Lokalnamen ({name}) ein, um zu bestätigen.",
  ...
  "creator.signup.sub": "Werde mit lokalen Lokale gematcht und verdiene pro View.",
  ...
  "creator.profile.title": "Über dich",
  "creator.profile.sub": "Ein paar Angaben, damit Lokale wissen, mit wem sie zusammenarbeiten.",
  "creator.profile.name": "Name",
  "creator.profile.age": "Alter",
  "creator.profile.gender": "Geschlecht",
  "creator.profile.followers": "Follower gesamt",
  "creator.profile.picHint": "Foto hinzufügen",
  "creator.profile.picCta": "Bild wählen",
  "creator.profile.picNote": "Quadratisch passt am besten.",
  "creator.profile.picRemove": "Entfernen",
  "creator.profile.picFail": "Bild konnte nicht gelesen werden — versuch ein anderes.",
  "creator.profile.needAll": "Bitte fülle alle Felder aus.",
  "creator.profile.picTooBig": "Das Bild ist zu groß (max. 3 MB).",
  "creator.profile.needName": "Gib deinen Namen ein.",
  "creator.profile.cta": "Weiter",
  "creator.pgender.female": "Weiblich",
  "creator.pgender.male": "Männlich",
  "creator.pgender.diverse": "Divers",
  "creator.pgender.prefer_not": "Keine Angabe",
  "creator.channels.topCities": "Top-Städte des Publikums (Top 5)",
  "creator.channels.ageRange": "Top-Altersgruppen",
  "creator.channels.gender": "Top-Geschlecht",
  "creator.channels.rankHint": "(der Reihe nach antippen — höchste zuerst)",
  "creator.city.pick": "Auswählen…",
  "creator.city.otherDe": "Andere in Deutschland",
  "creator.city.otherIntl": "Andere außerhalb Deutschlands",
  "creator.aud.men": "Männer",
  "creator.aud.women": "Frauen",
  "cr.m.ig.views": "Aufrufe (30 Tage)",
  "cr.m.ig.reached": "Erreichte Konten (30 Tage)",
  "cr.m.ig.clicks": "Klicks auf externe Links",
  "cr.m.tt.views": "Videoaufrufe (28 Tage)",
  "cr.m.tt.reached": "Zuschauer gesamt (28 Tage)",
  "cr.m.tt.clicks": "Klicks auf Bio-Link",
  "cr.m.yt.views": "Aufrufe",
  "cr.m.yt.reached": "Eindeutige Zuschauer",
  "cr.m.yt.clicks": "Klicks (Endscreen + Infokarten)",
  ...
  "creator.handles.needComplete": "Vervollständige mindestens einen Kanal: alle 5 Städte, alle Altersgruppen und Geschlechter eingestuft und alle drei Kennzahlen.",
  ...
  "creator.done.sub": "Wir matchen dich mit passenden Lokale. Behalte dein Postfach im Auge.",
  "creator.done.inbox": "Zum Postfach",
  "creator.home.accounts": "Konten verwalten",
  "creator.home.title": "Trending Table",
  "creator.venueFallback": "Lokal",
  "creator.tab.campaigns": "Kampagnen",
  "creator.tab.messages": "Nachrichten",
  "creator.nav.services": "Service",
  "creator.nav.account": "Konto",
  "creator.services.title": "Service",
  "creator.services.sub": "Buche Pläne und Add-ons, um mehr aus Trending Table herauszuholen.",
  "creator.services.loading": "Services werden geladen…",
  "creator.services.yourPlan": "Dein Abo",
  "creator.services.yourPlanDesc": "Dieses Angebot nutzt du aktuell.",
  "creator.services.upgrade": "Upgrade jetzt dein Abo",
  "creator.services.upgradeDesc": "Wechsle in ein höheres Abo für mehr Kooperationen und Reichweite.",
  "creator.services.moreJobs": "Sichere dir mehr Aufträge",
  "creator.services.moreJobsDesc": "Add-ons, die deine Sichtbarkeit erhöhen, damit Brands dich vor anderen Influencern finden.",
  "creator.services.recommended": "Empfohlen",
  "creator.services.currentBadge": "Aktuelles Abo",
  "creator.services.topPlan": "Du bist bereits im höchsten Abo.",
  "creator.services.catalogEmpty": "Aktuell sind keine Services verfügbar.",
  "creator.services.book": "Jetzt buchen",
  "creator.services.booked": "Gebucht",
  "creator.services.redirecting": "Weiterleitung…",
  "creator.services.since": "seit",
  "creator.services.free": "Kostenlos",
  "creator.services.perMonth": "/ Monat",
  "creator.services.oneTime": "einmalig",
  "creator.services.stripeOff": "Zahlungen sind in dieser Umgebung noch nicht aktiviert — Services können hier nicht gebucht werden.",
  "creator.services.coops": "Bis zu {n} Kooperationen",
  "creator.services.coopsOne": "Bis zu {n} Kooperation",
  "creator.services.coopsUnlimited": "Unbegrenzte Kooperationen",
  "creator.services.freeCoops": "Eine Kooperation alle 3 Monate",
  "creator.services.advancedCoops": "Bis zu sechs Kooperationen alle 3 Monate",
  "creator.services.inclBoost": "Visibility Boost inklusive",
  "creator.services.boostDays": "{n} Tage erhöhte Sichtbarkeit",
  "creator.services.blockMonths": "{n} Monate Bindung",
  "creator.services.usageMonths": "{n} Monate Nutzungsrechte",
  "creator.account.sub": "Verwalte dein Profil und die Kanäle, die Brands sehen, wenn wir dich matchen.",
  "creator.account.profileTab": "Profil",
  "creator.account.channelsTab": "Kanäle",
  "creator.campaigns.soon": "Deine gematchten Kampagnen erscheinen hier, sobald wir dich mit Lokalen zusammenbringen.",
  "creator.campaigns.empty": "Noch keine Kampagnen — hier erscheinen Lokale, mit denen wir dich matchen.",
  "creator.campaigns.untitled": "Unbenannte Kampagne",
  "creator.campaigns.payout": "Deine Vergütung",
  "creator.campaigns.by": "posten bis",
  "creator.campaigns.linkPh": "Link zu deinem Post…",
  "creator.campaigns.submit": "Post einreichen",
  "creator.campaigns.update": "Link aktualisieren",
  "assignment.status.contacted": "Eingeladen",
  "assignment.status.posted": "Eingereicht",
  "assignment.status.approved": "Freigegeben",
  "assignment.status.paid": "Bezahlt",
  "assignment.status.declined": "Abgelehnt",
  "assignment.status.cancelled": "Storniert",
};
 ...
 * canonical string (it doubles as the translation key); free-text or unknown
 * values fall back to themselves rather than leaking the `chip.` key. */
export function tChip(englishLabel: string): string {
  const key = `chip.${englishLabel}`;
  return messages[current][key] ?? messages.en[key] ?? englishLabel;
}
