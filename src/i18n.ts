...
const en: Dict = {
  ...
  "restaurants.sub": "Your restaurants. Pick one to run campaigns, or add another.",
  "restaurants.new": "Add restaurant",
  "restaurants.empty": "No restaurants yet — add your first.",
  "restaurants.manage": "Manage",
  "restaurants.search": "Find your restaurant on Google",
  "restaurants.searchPh": "Restaurant name…",
  ...
  "restaurants.err.name": "Enter a restaurant name.",
  "restaurants.or": "or add it manually:",
  "restaurants.manualPh": "Restaurant name",
  "restaurants.add": "Add",
  "restaurants.delete": "Delete restaurant",
  "restaurants.deleteHint": "Permanently remove this restaurant and its campaigns. This can't be undone.",
  "restaurants.deleteConfirm": "Type the restaurant name ({name}) to confirm deletion.",
  "account.nav.messages": "Messages",
  "campaigns.sub": "Create a campaign, set a budget, and we bring the creators.",
  "campaigns.noRestaurant": "Add a restaurant first to run campaigns.",
  ...
  "campaigns.f.restaurant": "Restaurant",
  ...
  "creator.campaigns.empty": "No campaigns yet — restaurants we match you with show up here.",
...
const de: Dict = {
  ...
  "restaurants.sub": "Deine Restaurants. Wähle eins für Kampagnen aus oder füge ein weiteres hinzu.",
  "restaurants.new": "Restaurant hinzufügen",
  "restaurants.empty": "Noch keine Restaurants — füge dein erstes hinzu.",
  "restaurants.manage": "Verwalten",
  "restaurants.search": "Finde dein Restaurant bei Google",
  "restaurants.searchPh": "Restaurantname…",
  ...
  "restaurants.err.name": "Gib einen Restaurantnamen ein.",
  "restaurants.or": "oder manuell hinzufügen:",
  "restaurants.manualPh": "Restaurantname",
  "restaurants.add": "Hinzufügen",
  "restaurants.delete": "Restaurant löschen",
  "restaurants.deleteHint": "Dieses Restaurant und seine Kampagnen dauerhaft entfernen. Das kann nicht rückgängig gemacht werden.",
  "restaurants.deleteConfirm": "Gib den Restaurantnamen ({name}) ein, um das Löschen zu bestätigen.",
  "account.nav.messages": "Nachrichten",
  "campaigns.sub": "Erstelle eine Kampagne, lege ein Budget fest — wir bringen die Creator.",
  "campaigns.noRestaurant": "Füge zuerst ein Restaurant hinzu, um Kampagnen zu starten.",
  ...
  "creator.campaigns.empty": "Noch keine Kampagnen — hier erscheinen Restaurants, mit denen wir dich matchen.",
