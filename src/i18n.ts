...
const en: Dict = {
  ...
  "pay.welcome": "Welcome offer: {percent}% off your first month — {first}, then {regular}/mo.",
  ...
  "account.comingSoonSub": "This part of the platform isn't live yet — we're building it.",
...
const de: Dict = {
  ...
  "pay.welcome": "Welcome-Angebot: {percent}% Rabatt im ersten Monat — {first}, danach {regular}/Monat.",
  ...
  "account.comingSoonSub": "Dieser Teil der Plattform ist noch nicht verfügbar — wir bauen ihn gerade.",
