...
const en: Dict = {
  ...
  "review.avoid": "Avoid",
  "review.consent":
    "I agree to the Terms and Privacy Policy. Creating a locale is free; launching a campaign costs a €9.99 fee.",
...
const de: Dict = {
  ...
  "review.consent":
    "Ich stimme den AGB und der Datenschutzerklärung zu. Ein Lokal anzulegen ist kostenlos; eine Kampagne zu starten kostet 9,99 €.",
