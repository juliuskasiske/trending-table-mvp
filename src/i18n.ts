...
const de: Dict = {
  ...
  "creator.services.yourPlanDesc": "Das ist das Abo, das du aktuell nutzt.",
  ...
  "creator.services.moreJobsDesc": "Einmalige Add-ons, die deine Sichtbarkeit erhöhen, damit Brands dich schneller finden.",
